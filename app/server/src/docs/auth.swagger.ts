 ...
 * tags:
 *   name: Auth
 *   description: Authentication endpoints for Staffly
 */
 ...
 *       - Auth
 *     summary: Logout user
 *     description: Logs out the currently authenticated user by clearing the refresh token cookie. Requires a valid access token in the `Authorization` header.
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 ...
 *     description: Logs the user out from all devices by invalidating all active refresh tokens. Requires a valid access token in the `Authorization` header.
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
