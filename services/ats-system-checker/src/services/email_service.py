...
class EmailService:
    ...
    def __init__(self, gmail_user: str, gmail_password: str, database_service: Optional["DatabaseService"] = None, frontend_url: str = None):
        """
...
"""
    ...
    async def send_acceptance_email_with_quiz(
        ...
        quiz_link = f"{self.backend_url}/api/quiz/{quiz_session_id}"
